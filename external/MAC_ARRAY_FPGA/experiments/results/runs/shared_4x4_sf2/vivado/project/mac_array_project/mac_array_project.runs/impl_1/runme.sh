...
HD_PWD='/home/keelan/rtl_agent_loop/external/MAC_ARRAY_FPGA/experiments/results/runs/shared_4x4_sf2/vivado/project/mac_array_project/mac_array_project.runs/impl_1'
cd "$HD_PWD"
