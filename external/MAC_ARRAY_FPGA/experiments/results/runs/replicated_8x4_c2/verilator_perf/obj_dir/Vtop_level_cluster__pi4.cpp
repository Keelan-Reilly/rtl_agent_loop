...
VL_INLINE_OPT void Vtop_level_cluster__pi4::_sequent__TOP__top_level__DOT__gen_clusters__BRA__0__KET____DOT__u_cluster__33(Vtop_level__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_level_cluster__pi4::_sequent__TOP__top_level__DOT__gen_clusters__BRA__0__KET____DOT__u_cluster__33\n"); );
...
VL_INLINE_OPT void Vtop_level_cluster__pi4::_settle__TOP__top_level__DOT__gen_clusters__BRA__0__KET____DOT__u_cluster__49(Vtop_level__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_level_cluster__pi4::_settle__TOP__top_level__DOT__gen_clusters__BRA__0__KET____DOT__u_cluster__49\n"); );
    Vtop_level* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
