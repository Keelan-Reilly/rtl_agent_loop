...
void Vtop_level_cluster__pi4::_settle__TOP__top_level__DOT__gen_clusters__BRA__0__KET____DOT__u_cluster__1(Vtop_level__Syms* __restrict vlSymsp) {
    ...
    this->__PVT__pe_valid[2U] = 1U;
    this->__PVT__pe_valid[3U] = 1U;
...
void Vtop_level_cluster__pi4::_ctor_var_reset() {
    ...
    __Vcellout__gen_main_pes__BRA__2__KET____DOT__u_pe__acc_result = VL_RAND_RESET_I(32);
    __Vcellout__gen_main_pes__BRA__3__KET____DOT__u_pe__acc_result = VL_RAND_RESET_I(32);
    ...
    __PVT__gen_main_pes__BRA__2__KET____DOT__u_pe__DOT__product_full = VL_RAND_RESET_I(32);
    __PVT__gen_main_pes__BRA__2__KET____DOT__u_pe__DOT__product_scaled = VL_RAND_RESET_I(32);
    __PVT__gen_main_pes__BRA__3__KET____DOT__u_pe__DOT__product_full = VL_RAND_RESET_I(32);
    __PVT__gen_main_pes__BRA__3__KET____DOT__u_pe__DOT__product_scaled = VL_RAND_RESET_I(32);
    __Vdlyvset__accum_bank__v0 = 0;
    __Vdlyvval__accum_bank__v4 = VL_RAND_RESET_I(32);
    __Vdlyvset__accum_bank__v4 = 0;
    __Vdlyvval__accum_bank__v5 = VL_RAND_RESET_I(32);
    __Vdlyvval__accum_bank__v6 = VL_RAND_RESET_I(32);
    __Vdlyvval__accum_bank__v7 = VL_RAND_RESET_I(32);
    __Vdlyvset__shadow_accum_bank__v0 = 0;
    __Vdlyvval__shadow_accum_bank__v4 = VL_RAND_RESET_I(32);
    __Vdlyvset__shadow_accum_bank__v4 = 0;
    __Vdlyvval__shadow_accum_bank__v5 = VL_RAND_RESET_I(32);
    __Vdlyvval__shadow_accum_bank__v6 = VL_RAND_RESET_I(32);
    __Vdlyvval__shadow_accum_bank__v7 = VL_RAND_RESET_I(32);
}
