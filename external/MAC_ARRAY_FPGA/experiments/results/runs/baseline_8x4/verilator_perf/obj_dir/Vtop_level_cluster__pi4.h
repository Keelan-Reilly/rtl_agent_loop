...
VL_MODULE(Vtop_level_cluster__pi4) {
  ...
  public:
    ...
    void _combo__TOP__top_level__DOT__gen_clusters__BRA__0__KET____DOT__u_cluster__17(Vtop_level__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset() VL_ATTR_COLD;
  public:
    void _sequent__TOP__top_level__DOT__gen_clusters__BRA__0__KET____DOT__u_cluster__9(Vtop_level__Syms* __restrict vlSymsp);
