...
VL_MODULE(Vtop_level_cluster__pi4) {
  ...
  public:
    void _sequent__TOP__top_level__DOT__gen_clusters__BRA__0__KET____DOT__u_cluster__65(Vtop_level__Syms* __restrict vlSymsp);
    ...
    void _settle__TOP__top_level__DOT__gen_clusters__BRA__0__KET____DOT__u_cluster__33(Vtop_level__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    void _settle__TOP__top_level__DOT__gen_clusters__BRA__0__KET____DOT__u_cluster__97(Vtop_level__Syms* __restrict vlSymsp);
