...
VL_MODULE(Vtop_level_cluster__pi4) {
  public:
    ...
    VL_OUT(shadow_accum_out[4],31,0);
    ...
    IData/*31:0*/ __PVT__shadow_accum_bank[4];
    ...
    IData/*31:0*/ __PVT__shadow_accum_next[4];
    SData/*15:0*/ __PVT__shared_lane_a[4][1];
    SData/*15:0*/ __PVT__shared_lane_b[4][1];
    
    // LOCAL VARIABLES
    CData/*0:0*/ __Vdlyvset__accum_bank__v0;
    CData/*0:0*/ __Vdlyvset__accum_bank__v4;
    CData/*0:0*/ __Vdlyvset__shadow_accum_bank__v0;
    CData/*0:0*/ __Vdlyvset__shadow_accum_bank__v4;
    ...
    IData/*31:0*/ __Vdlyvval__shadow_accum_bank__v4;
    IData/*31:0*/ __Vdlyvval__shadow_accum_bank__v5;
    IData/*31:0*/ __Vdlyvval__shadow_accum_bank__v6;
    IData/*31:0*/ __Vdlyvval__shadow_accum_bank__v7;
  ...
  public:
    ...
    void _combo__TOP__top_level__DOT__gen_clusters__BRA__0__KET____DOT__u_cluster__33(Vtop_level__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset() VL_ATTR_COLD;
  public:
    void _sequent__TOP__top_level__DOT__gen_clusters__BRA__0__KET____DOT__u_cluster__17(Vtop_level__Syms* __restrict vlSymsp);
